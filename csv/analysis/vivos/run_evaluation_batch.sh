#!/bin/bash
#
# Vietnamese Audio TRUE BATCH Evaluation Runner (Optimized)
...
INPUT_CSV="vivos_filtered_full.csv"
OUTPUT_CSV="vivos_filtered_full.csv"
...
LOG_FILE="evaluation_vietnamese_${TIMESTAMP}.log"

echo "================================================================================"
echo "Vietnamese Audio TRUE BATCH Evaluation (OPTIMIZED)"
echo "================================================================================"
...
echo "================================================================================"
echo ""
echo "ASR Model:    PhoWhisper-large (Vietnamese)"
echo "WER:          fast_wer() from metrics_evaluator_v3.py"
echo "TER:          calculate_ter() from metrics_evaluator_v3.py (Vietnamese diacritics)"
...
conda run -n codec_eval_pip_py39 python evaluate_vietnamese_batch.py \
    "$INPUT_CSV" \
    "$OUTPUT_CSV" \
    --base-path "$BASE_PATH" \
    --gpu "$GPU_ID" \
