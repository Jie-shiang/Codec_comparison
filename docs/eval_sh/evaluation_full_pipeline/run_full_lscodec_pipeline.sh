...
echo "========================================="
echo "LSCodec Full Pipeline - Starting"
echo "========================================="
...
INFERENCE_BASE_DIR="/mnt/Internal/jieshiang/Inference_Result/LSCodec"

# Step 1: 產生推論檔案
echo ""
echo "Step 1: Generating inference files..."
bash "${INFERENCE_SCRIPT_DIR}/inference_lscodec.sh"

# Step 2: 執行評估
echo ""
echo "Step 2: Running evaluations..."
cd /home/jieshiang/Desktop/GitHub/Codec_comparison_tools/Codec_comparison
conda run -n "$EVAL_ENV" bash "${EVAL_SCRIPT_DIR}/run_lscodec_evaluations.sh"

# Step 3: 刪除推論檔案（保留資料夾結構）
echo ""
echo "Step 3: Cleaning up inference files..."

for FREQ in "25Hz" "50Hz"; do
...
echo ""
echo "========================================="
echo "LSCodec Full Pipeline - Completed"
echo "========================================="
