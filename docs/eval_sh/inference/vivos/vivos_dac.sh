...
# DAC Inference Script - VIVOS Only
# 生成 DAC 16kHz, 24kHz, 44kHz 的推論檔案 (VIVOS 資料集)

set -e

echo "========================================="
echo "DAC Inference (VIVOS) - Starting"
echo "========================================="
...
echo "Running DAC (16kHz, 24kHz, 44kHz) inference on VIVOS..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/DAC/{16khz,24khz,44khz}_8kbps/vivos"
...
echo "========================================="
echo "DAC Inference (VIVOS) - Completed"
echo "========================================="
