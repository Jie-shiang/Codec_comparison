...
# Mimi Inference Script - VIVOS Only
# 生成 Mimi 12.5Hz_8k 和 12.5Hz_16k 的推論檔案 (VIVOS 資料集)

set -e

echo "========================================="
echo "Mimi Inference (VIVOS) - Starting"
echo "========================================="
...
echo "Running Mimi inference on VIVOS..."
echo "Environment: $CONDA_ENV"

# Mimi 12.5Hz_8k (4 layers)
echo ""
echo "Running Mimi 12.5Hz_8k (4 layers) on VIVOS..."
echo "Output: $OUTPUT_DIR/MimiCodec/12.5Hz_8k/vivos"
...
echo ""
echo "Running Mimi 12.5Hz_16k (8 layers) on VIVOS..."
echo "Output: $OUTPUT_DIR/MimiCodec/12.5Hz_16k/vivos"
...
echo "========================================="
echo "Mimi Inference (VIVOS) - Completed"
echo "========================================="
