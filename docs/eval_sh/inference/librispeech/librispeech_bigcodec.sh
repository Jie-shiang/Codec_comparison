...
# BigCodec Inference Script - LibriSpeech Only
# 生成 BigCodec 80Hz 的推論檔案 (LibriSpeech 資料集)

set -e

echo "========================================="
echo "BigCodec Inference (LibriSpeech) - Starting"
echo "========================================="
...
echo "Running BigCodec 80Hz inference on LibriSpeech..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/$CODEC_NAME/$BITRATE/librispeech"
...
echo "========================================="
echo "BigCodec Inference (LibriSpeech) - Completed"
echo "========================================="
