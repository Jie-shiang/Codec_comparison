...
# NanoCodec Inference Script - LibriSpeech Only
# 生成 NanoCodec 12.5Hz_2k, 12.5Hz_4k, 21.5Hz_2k 的推論檔案 (LibriSpeech 資料集)

set -e

echo "========================================="
echo "NanoCodec Inference (LibriSpeech) - Starting"
echo "========================================="
...
DATASET="librispeech"
CSV_PATH="${CSV_DIR}/librispeech_filtered_clean.csv"
...
echo "========================================="
echo "NanoCodec Inference (LibriSpeech) - All Completed"
echo "========================================="
