...
# NanoCodec Inference Script - MDCC Only
# 生成 NanoCodec 12.5Hz_2k, 12.5Hz_4k, 21.5Hz_2k 的推論檔案 (MDCC 資料集)

set -e

echo "========================================="
echo "NanoCodec Inference (MDCC) - Starting"
echo "========================================="
...
DATASET="mdcc"
CSV_PATH="${CSV_DIR}/mdcc_filtered_clean.csv"
...
echo "========================================="
echo "NanoCodec Inference (MDCC) - All Completed"
echo "========================================="
