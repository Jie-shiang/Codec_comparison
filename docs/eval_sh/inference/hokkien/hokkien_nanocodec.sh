...
# NanoCodec Inference Script - Hokkien Only
# 生成 NanoCodec 12.5Hz_2k, 12.5Hz_4k, 21.5Hz_2k 的推論檔案 (Hokkien 資料集)

set -e

echo "========================================="
echo "NanoCodec Inference (Hokkien) - Starting"
echo "========================================="
...
DATASET="hokkien"
CSV_PATH="${CSV_DIR}/hokkien_filtered_clean.csv"
...
echo "========================================="
echo "NanoCodec Inference (Hokkien) - All Completed"
echo "========================================="
