...
# SpeechTokenizer Inference Script - Hokkien Only
# 生成 SpeechTokenizer 50Hz 的推論檔案 (Hokkien 資料集)

set -e

echo "========================================="
echo "SpeechTokenizer Inference (Hokkien) - Starting"
echo "========================================="
...
echo "Running SpeechTokenizer 50Hz inference on Hokkien..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/SpeechTokenizer/50Hz/hokkien"
...
echo "========================================="
echo "SpeechTokenizer Inference (Hokkien) - Completed"
echo "========================================="
