...
# DAC Inference Script - Hokkien Only
# 生成 DAC 16kHz, 24kHz, 44kHz 的推論檔案 (Hokkien 資料集)

set -e

echo "========================================="
echo "DAC Inference (Hokkien) - Starting"
echo "========================================="
...
echo "Running DAC (16kHz, 24kHz, 44kHz) inference on Hokkien..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/DAC/{16khz,24khz,44khz}_8kbps/hokkien"
...
echo "========================================="
echo "DAC Inference (Hokkien) - Completed"
echo "========================================="
