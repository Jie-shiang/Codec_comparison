...
# FocalCodec Inference Script - Hokkien Only
# 生成 FocalCodec 12.5Hz, 25Hz, 50Hz 的推論檔案 (Hokkien 資料集)

set -e

echo "========================================="
echo "FocalCodec Inference (Hokkien) - Starting"
echo "========================================="
...
echo "Running FocalCodec (12.5Hz, 25Hz, 50Hz) inference on Hokkien..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/FocalCodec/{12.5HZ,25HZ,50HZ}/hokkien"
...
echo "========================================="
echo "FocalCodec Inference (Hokkien) - Completed"
echo "========================================="
