...
# FocalCodec Inference Script - Aishell Only
# 生成 FocalCodec 12.5Hz, 25Hz, 50Hz 的推論檔案 (Aishell 資料集)

set -e

echo "========================================="
echo "FocalCodec Inference (Aishell) - Starting"
echo "========================================="
...
echo "Running FocalCodec (12.5Hz, 25Hz, 50Hz) inference on Aishell..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/FocalCodec/{12.5HZ,25HZ,50HZ}/aishell"
...
echo "========================================="
echo "FocalCodec Inference (Aishell) - Completed"
echo "========================================="
