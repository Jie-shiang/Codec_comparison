...
# LSCodec Inference Script - Aishell Only
# 生成 LSCodec 25Hz 和 50Hz 的推論檔案 (Aishell 資料集)

set -e

echo "========================================="
echo "LSCodec Inference (Aishell) - Starting"
echo "========================================="
...
echo "Running LSCodec 25Hz and 50Hz inference on Aishell..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/LSCodec/{25Hz,50Hz}/aishell"
...
echo "========================================="
echo "LSCodec Inference (Aishell) - Completed"
echo "========================================="
