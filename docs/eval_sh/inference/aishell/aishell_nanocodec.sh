...
# NanoCodec Inference Script - Aishell Only
# 生成 NanoCodec 12.5Hz_2k, 12.5Hz_4k, 21.5Hz_2k 的推論檔案 (Aishell 資料集)

set -e

echo "========================================="
echo "NanoCodec Inference (Aishell) - Starting"
echo "========================================="
...
echo "========================================="
echo "NanoCodec Inference (Aishell) - All Completed"
echo "========================================="
