...
# LSCodec Inference Script - CommonVoice Only
# 生成 LSCodec 25Hz 和 50Hz 的推論檔案 (CommonVoice 資料集)

set -e

echo "========================================="
echo "LSCodec Inference (CommonVoice) - Starting"
echo "========================================="
...
echo "Running LSCodec 25Hz and 50Hz inference on CommonVoice..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/LSCodec/{25Hz,50Hz}/commonvoice"
...
echo "========================================="
echo "LSCodec Inference (CommonVoice) - Completed"
echo "========================================="
