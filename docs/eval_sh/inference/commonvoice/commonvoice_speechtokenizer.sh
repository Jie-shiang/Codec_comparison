...
# SpeechTokenizer Inference Script - CommonVoice Only
# 生成 SpeechTokenizer 50Hz 的推論檔案 (CommonVoice 資料集)

set -e

echo "========================================="
echo "SpeechTokenizer Inference (CommonVoice) - Starting"
echo "========================================="
...
echo "Running SpeechTokenizer 50Hz inference on CommonVoice..."
echo "Environment: $CONDA_ENV"
echo "Output: $OUTPUT_DIR/SpeechTokenizer/50Hz/commonvoice"
...
echo "========================================="
echo "SpeechTokenizer Inference (CommonVoice) - Completed"
echo "========================================="
