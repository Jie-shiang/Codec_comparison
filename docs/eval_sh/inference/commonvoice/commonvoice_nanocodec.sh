...
# NanoCodec Inference Script - CommonVoice Only
# 生成 NanoCodec 12.5Hz_2k, 12.5Hz_4k, 21.5Hz_2k 的推論檔案 (CommonVoice 資料集)

set -e

echo "========================================="
echo "NanoCodec Inference (CommonVoice) - Starting"
echo "========================================="
...
DATASET="commonvoice"
CSV_PATH="${CSV_DIR}/commonvoice_filtered_clean.csv"
...
echo "========================================="
echo "NanoCodec Inference (CommonVoice) - All Completed"
echo "========================================="
