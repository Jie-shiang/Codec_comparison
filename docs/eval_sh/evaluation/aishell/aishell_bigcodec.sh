...
# BigCodec Evaluation Script - Aishell Dataset
...
echo "Starting BigCodec Evaluation - Aishell Dataset"

# BigCodec 80Hz - Aishell (zh)
echo "Running: BigCodec 80Hz - Aishell (zh)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/BigCodec/80Hz/aishell \
...
echo "BigCodec evaluation on Aishell completed."
