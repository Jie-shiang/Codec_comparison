...
# BigCodec Evaluation Script - Commonvoice Dataset
...
echo "Starting BigCodec Evaluation - Commonvoice Dataset"

# BigCodec 80Hz - Commonvoice (zh)
echo "Running: BigCodec 80Hz - Commonvoice (zh)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/BigCodec/80Hz/commonvoice \
...
echo "BigCodec evaluation on Commonvoice completed."
