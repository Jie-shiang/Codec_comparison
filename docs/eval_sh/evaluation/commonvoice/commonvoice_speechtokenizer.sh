...
# SpeechTokenizer Evaluation Script - Commonvoice Dataset
...
echo "Starting SpeechTokenizer Evaluation - Commonvoice Dataset"

# SpeechTokenizer 50Hz - Commonvoice (zh)
echo "Running: SpeechTokenizer 50Hz - Commonvoice (zh)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/SpeechTokenizer/50Hz/commonvoice \
...
echo "SpeechTokenizer evaluation on Commonvoice completed."
