...
# FocalCodec Evaluation Script - Commonvoice Dataset
...
echo "Starting FocalCodec Evaluation - Commonvoice Dataset"

# FocalCodec 12.5Hz - Commonvoice (zh)
echo "Running: FocalCodec 12.5Hz - Commonvoice (zh)"
...
# FocalCodec 25Hz - Commonvoice (zh)
echo "Running: FocalCodec 25Hz - Commonvoice (zh)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
...
# FocalCodec 50Hz - Commonvoice (zh)
echo "Running: FocalCodec 50Hz - Commonvoice (zh)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
...
echo "FocalCodec evaluation on Commonvoice completed."
