...
# SpeechTokenizer Evaluation Script - Hokkien Dataset
...
echo "Starting SpeechTokenizer Evaluation - Hokkien Dataset"

# SpeechTokenizer 50Hz - Hokkien (min)
echo "Running: SpeechTokenizer 50Hz - Hokkien (min)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/SpeechTokenizer/50Hz/hokkien \
...
echo "SpeechTokenizer evaluation on Hokkien completed."
