...
# BigCodec Evaluation Script - Hokkien Dataset
...
echo "Starting BigCodec Evaluation - Hokkien Dataset"

# BigCodec 80Hz - Hokkien (min)
echo "Running: BigCodec 80Hz - Hokkien (min)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/BigCodec/80Hz/hokkien \
...
echo "BigCodec evaluation on Hokkien completed."
