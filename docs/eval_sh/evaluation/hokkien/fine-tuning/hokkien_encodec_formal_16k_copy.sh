...
OUTPUT_DIR="/home/jieshiang/Desktop/GitHub/Codec_comparison_tools/Codec_comparison_pitch_v2"
...
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Model/EnCodec/two_stage/stage2_latent_dropout/inference \
    --csv_file "${CSV_DIR}/hokkien_filtered_clean.csv" \
    --original_dir /mnt/Internal/ASR \
    --model_name "EnCodec" \
    --frequency "75Hz_4k_stage_2_dropout_full" \
    --causality "Causal" \
    --bit_rate "3.0" \
    --quantizers "4" \
    --codebook_size "1024" \
