...
# SpeechTokenizer Evaluation Script - Mdcc Dataset
...
echo "Starting SpeechTokenizer Evaluation - Mdcc Dataset"

# SpeechTokenizer 50Hz - Mdcc (yue)
echo "Running: SpeechTokenizer 50Hz - Mdcc (yue)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/SpeechTokenizer/50Hz/mdcc \
...
echo "SpeechTokenizer evaluation on Mdcc completed."
