...
# FocalCodec Evaluation Script - LibriSpeech Dataset
...
echo "Starting FocalCodec Evaluation - LibriSpeech Dataset"

# FocalCodec 12.5Hz - LibriSpeech (English)
echo "Running: FocalCodec 12.5Hz - LibriSpeech (English)"
...
# FocalCodec 25Hz - LibriSpeech (English)
echo "Running: FocalCodec 25Hz - LibriSpeech (English)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
...
# FocalCodec 50Hz - LibriSpeech (English)
echo "Running: FocalCodec 50Hz - LibriSpeech (English)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
...
echo "FocalCodec evaluation on LibriSpeech completed."
