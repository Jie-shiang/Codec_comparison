...
# BigCodec Evaluation Script - LibriSpeech Dataset
...
echo "Starting BigCodec Evaluation - LibriSpeech Dataset"

# BigCodec 80Hz - LibriSpeech (English)
echo "Running: BigCodec 80Hz - LibriSpeech (English)"
...
echo "BigCodec evaluation on LibriSpeech completed."
