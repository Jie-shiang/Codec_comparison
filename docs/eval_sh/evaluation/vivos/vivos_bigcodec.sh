...
# BigCodec Evaluation Script - Vivos Dataset
...
echo "Starting BigCodec Evaluation - Vivos Dataset"

# BigCodec 80Hz - Vivos (vi)
echo "Running: BigCodec 80Hz - Vivos (vi)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/BigCodec/80Hz/vivos \
...
echo "BigCodec evaluation on Vivos completed."
