...
# SpeechTokenizer Evaluation Script - Vivos Dataset
...
echo "Starting SpeechTokenizer Evaluation - Vivos Dataset"

# SpeechTokenizer 50Hz - Vivos (vi)
echo "Running: SpeechTokenizer 50Hz - Vivos (vi)"
conda run -n "$EVAL_ENV" python "${SCRIPT_DIR}/fast_evaluation_pipeline.py" \
    --inference_dir /mnt/Internal/jieshiang/Inference_Result/SpeechTokenizer/50Hz/vivos \
...
echo "SpeechTokenizer evaluation on Vivos completed."
